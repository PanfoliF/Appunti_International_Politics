...
\input{Tex/session2a_power_transition_levy_causes_war.tex}
\input{Tex/session2b.tex}
\input{Tex/session2c.tex}
\input{Tex/session2d_lake_why_isms_are_evil.tex}
\input{Tex/session2e_lake_risse_challenges_to_liberal_order.tex}

\newpage
\part{Session 3}
\textbf{Session 3, February 23: The strategic perspective}
\input{Tex/session3.tex}
\input{Tex/session3b_selectorate_theory.tex}

\newpage
\part{Session 4}
\textbf{Session 4, March 2: Bargaining theory of war}
\input{Tex/session4.tex}
\input{Tex/session4b.tex}

\newpage
\part{Session 5}
\textbf{Session 5, March 9: Domestic theories of war}
\input{Tex/session5.tex}
\input{Tex/session5_four_summaries.tex}

\newpage
\part{Session 6}
\textbf{Session 6, March 16: Psychological theories of war}
\input{Tex/session6.tex}
\input{Tex/session6_summaries.tex}

\newpage
\part{Session 7}
\textbf{Session 7, March 23: International organizations and military alliances}
\input{Tex/session7.tex}
\input{Tex/session7_summaries.tex}

\newpage
\part{Session 8}
\textbf{Session 8, April 13: International norms}
\input{Tex/session08.tex}
\input{Tex/session8_summaries.tex}

% \newpage
% \part{Session 10}
% \textbf{Session 10, April 27: Climate change}
% \input{Tex/session10.tex}
% \input{Tex/session10_summaries.tex}

% \newpage
% \part{Session 11}
% \textbf{Session 11, May 4: Human rights}
% \input{Tex/session11.tex}
% \input{Tex/session11_summaries.tex}

% \newpage
% \part{Session 12}
% \textbf{Session 12, May 11: Terrorism}
% \input{Tex/session12.tex}
% \input{Tex/session12_summaries.tex}
