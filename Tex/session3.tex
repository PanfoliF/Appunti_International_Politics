...
\subsection{A BRIEF HISTORY OF INTERNATIONAL RELATIONS THINKING}
...
\textbf{SOLVING INTERNATIONAL RELATIONS PUZZLES}
...
\subsection{Power, Preferences, and Perceptions: The Three Pillars of International Relations}
...
Scientific analysis requires logical consistency

Competing arguments can be evaluated through experiments that control for confounding, alternative explanations.

Randomness ensures that the tests control for the possible effects of other factors.

Tests must also be replicable;
