...
\subsection{Bipolarity and Stability by Chat}

\subsubsection*{Bipolarity and Stability — Condensed Notes}

\paragraph*{1. Bipolar vs. Multipolar Systems}
...
\subparagraph*{Neorealist logic}
\[
Bipolarity \rightarrow Less\ uncertainty \rightarrow Greater\ stability
\]
...
\subsubsection*{2. Historical Illustration}
...
\subsubsection*{3. Problem with the Uncertainty Argument}
...
\subsubsection*{4. Problem for Neorealist Assumptions}
...
\subsubsection*{5. Bipolar Balance of Power}
...
A is stronger and B has no third power to call for help.

\paragraph*{Implication}
Strict neorealist logic suggests that bipolar stability requires \textbf{near-perfect equality of power}.

\medskip
\noindent\rule{\linewidth}{0.4pt}
\medskip

\subsubsection*{6. Multipolar Stability}

In a multipolar system, stability depends on \textbf{blocking coalitions}.

A coalition controlling half the system’s resources:

\[
R/2
\]

can prevent another coalition from becoming dominant.
...
\subsubsection*{7. Essential vs. Inessential States}

\paragraph*{Essential state}
A state is essential if it is needed to form at least one:
\begin{itemize}
...
\subsubsection*{8. Example of a Stable Multipolar System}
...
\subsubsection*{9. Example of an Unstable Multipolar System}
...
\subsubsection*{10. Main Implication for Multipolarity}
...
\subsubsection*{11. Bipolarity and Stability: Second Look}
...
\subsubsection*{12. Weak but Dissatisfied State}
...
A attacks despite being much weaker.

\medskip
\noindent\rule{\linewidth}{0.4pt}
\medskip

\subsubsection*{13. Strong but Satisfied State}
...
\subsubsection*{14. Why This Contradicts Neorealism}

This model assumes states can make a:

\begin{quote}
\textbf{trade-off between security and power}
\end{quote}

But according to Kenneth Waltz:

\begin{quote}
\textbf{security is the highest end.}
\end{quote}
...
\subsubsection*{15. Overall Conclusion}

The traditional claim:

\[
Bipolarity \rightarrow Stability
\]
